...
%\usepackage{autonum}
%
%% multiple figures, see https://texblog.org/2014/01/23/sub-caption-above-subfigures-and-subtables/
%\usepackage[justification=justified,singlelinecheck=false]{subcaption}
%%\usepackage[justification=justified,singlelinecheck=false]{subfig}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% only used if tikz images are build inside the document!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% graphics
%\usepackage{tikz}
%
%% use special tikz libraries
%%\usetikzlibrary{spy, backgrounds, patterns}
%%\usetikzlibrary{patterns, calc, 3d, arrows}
%
...
%\pgfplotsset{compat=1.12}
%
%% draw commutative diagrams using tikz
%\usepackage{tikz-cd} 
%\tikzcdset{every label/.append style = {font = \normalsize}} % use this, otherwise nodes beside arrows are too small
%
%%%%%%%%%%%%%%
...
% Algorithmen
\usepackage[linesnumbered,lined,boxed,commentsnumbered,english]{algorithm2e}
%\usepackage[german,boxruled,algochapter]{algorithm2e}
...
%\newcommand{\frz}{\mathfrak{z}}
%
%% big O notation, see https://tex.stackexchange.com/questions/354681/big-o-notation-visual-difference-related-to-document-configurations
